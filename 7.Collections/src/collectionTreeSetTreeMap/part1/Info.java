...
public class Info {
    ...
    //tailSet(х) - возвращает все элементы, которые больше или равны х

    //higher(х) - возвращается ближайшее большее число к указанному
    //lower(x) - возвращает ближайшее меньшее число к указанному
    //ceiling(x) - возвращает ближайшее меньшее число к указанному или само число, если оно содержится во множестве
